...
RSpec.describe 'Articles', type: :request do
  ...
  describe 'GET #new' do
    describe 'valid: ' do
      # Non-Admin users are unable to create new articles
    end

    describe 'invalid: ' do
      # Non-Admin users are unable to create new articles, so no invalid case
    end
  end

  describe 'GET #edit' do
    describe 'valid: ' do
      # Non-Admin users are unable to edit articles
    end

    describe 'invalid: ' do
      # Non-Admin users are unable to edit articles, so no invalid case
    end
  end

  describe 'DELETE #destroy' do
    describe 'valid: ' do
      # Non-Admin users are unable to delete articles
    end
  end
end